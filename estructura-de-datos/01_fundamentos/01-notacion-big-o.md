...
La notación Big-O sirve para describir como aumenta el tiempo de ejecución o el uso de memoria de un algoritmo a medida que crece la cantidad de datos de entrada
...
2. **Complejidad Especial:** mide la **memoria adicional** que se reserva.
   ...
   EJ: _variables, arreglos, llamadas recursivas..._
...
Típica de algoritmos de ordenación eficientes (_MergeSort_). Se da cuando dividimos el problema a la mitad (O(log n)) y en cada nivel procesamos todos los elementos O(n).
